...
export const getclients = async (req, res, next) => {
  try {
    ...
    const clients = await Client.find({
      ...
      ...(req.query.drivingDetail && { drivingDetail: req.query.drivingDetail }),
      ...
      ...(req.query.cocUsageMethod && { cocUsageMethod: req.query.cocUsageMethod }),
      ...(req.query.cocExpend && { cocExpend: req.query.cocExpend }),
      ...(req.query.cocYearBegin && { cocYearBegin: req.query.cocYearBegin }),
      ...(req.query.cocFrequency && { cocFrequency: req.query.cocFrequency }),

      ...(req.query.marUsageMethod && { marUsageMethod: req.query.marUsageMethod }),
      ...(req.query.marExpend && { marExpend: req.query.marExpend }),
      ...(req.query.marYearBegin && { marYearBegin: req.query.marYearBegin }),
      ...(req.query.marFrequency && { marFrequency: req.query.marFrequency }),

      ...(req.query.heroinUsageMethod && { heroinUsageMethod: req.query.heroinUsageMethod }),
      ...(req.query.heroinExpend && { heroinExpend: req.query.heroinExpend }),
      ...(req.query.heroinYearBegin && { heroinYearBegin: req.query.heroinYearBegin }),
      ...(req.query.heroinFrequency && { heroinFrequency: req.query.heroinFrequency }),

      ...(req.query.otherDrugName && { otherDrugName: req.query.otherDrugName }),
      ...(req.query.otherUsageMethod && { otherUsageMethod: req.query.otherUsageMethod }),
      ...(req.query.otherExpend && { otherExpend: req.query.otherExpend }),
      ...(req.query.otherYearBegin && { otherYearBegin: req.query.otherYearBegin }),
      ...(req.query.otherFrequency && { otherFrequency: req.query.otherFrequency }),
    ...
    const updatedClient = await Client.findByIdAndUpdate(
      req.params.clientId,
      {
        $set: {
          ...
          drivingDetail:req.body.drivingDetail,
          ...
          cocUsageMethod:req.body.cocUsageMethod,
          cocExpend:req.body.cocExpend,
          cocYearBegin:req.body.cocYearBegin,
          cocFrequency:req.body.cocFrequency,
          marUsageMethod:req.body.marUsageMethod,
          marExpend:req.body.marExpend,
          marYearBegin:req.body.marYearBegin,
          marFrequency:req.body.marFrequency,

          heroinUsageMethod:req.body.heroinUsageMethod,
          heroinExpend:req.body.heroinExpend,
          heroinYearBegin:req.body.heroinYearBegin,
          heroinFrequency:req.body.heroinFrequency,

          otherDrugName:req.body.otherDrugName,
          otherUsageMethod:req.body.otherUsageMethod,
          otherExpend:req.body.otherExpend,
          otherYearBegin:req.body.otherYearBegin,
          otherFrequency:req.body.otherFrequency,
